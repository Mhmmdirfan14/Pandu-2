...
class SelesaiPengaduan : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        return inflater.inflate(R.layout.selesai_pengaduan, container, false)
    }

    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        super.onViewCreated(view, savedInstanceState)

        val tvDetailSelesaiPengaduan: TextView = view.findViewById(R.id.tv_detail_selesai_pengaduan)
        tvDetailSelesaiPengaduan.setOnClickListener(this)
    ...
    override fun onClick(v: View?) {
        if(v?.id == R.id.tv_detail_selesai_pengaduan){
            val detailSelesaiPengaduan= DetailSelesaiPengaduan()
            val fragmentManager = parentFragmentManager
            fragmentManager.beginTransaction().apply {
                replace(R.id.container_fragment, detailSelesaiPengaduan, DetailSelesaiPengaduan::class.java.simpleName)
                addToBackStack(null)
                commit()
            }
        }
